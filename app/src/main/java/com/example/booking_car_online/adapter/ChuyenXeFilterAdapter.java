package com.example.booking_car_online.adapter;
...
public class ChuyenXeFilterAdapter extends RecyclerView.Adapter<ChuyenXeFilterAdapter.ChuyenXeFilterAdapterViewHolder>{
    ...
    @NonNull
    @Override
    public ChuyenXeFilterAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_filter_chuyen_xe, parent,false);

        return new ChuyenXeFilterAdapterViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull ChuyenXeFilterAdapterViewHolder holder, int position) {
