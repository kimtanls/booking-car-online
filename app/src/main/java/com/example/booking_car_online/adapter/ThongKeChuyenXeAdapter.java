...
public class ThongKeChuyenXeAdapter extends RecyclerView.Adapter<ThongKeChuyenXeAdapter.ThongKeChuyenXeViewHolder> {
    ...
    @NonNull
    @Override
    public ThongKeChuyenXeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_thong_ke_chuyen_xe, parent, false);

        return new ThongKeChuyenXeViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ThongKeChuyenXeViewHolder holder, int position) {
